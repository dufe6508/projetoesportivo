...
import { navegacao, contato, modalidades } from "@/lib/dados";
...
export function Header() {
  ...
  const fecharSub = () => {
    fechaSubmenu.current = window.setTimeout(() => setSubmenu(false), 200);
  };
  ...
  return (
    <>
      ...
      >
        <div
          className={`mx-auto flex max-w-[1320px] items-center justify-between gap-6 px-5 transition-all
        ...
        >
              ...
              return (
                ...
                >
                  ...
                  >
                    ...
                    <Icone
                      nome="CaretDown"
                      className={`h-3 w-3 opacity-70 transition-transform duration-200 ${submenu ? "rotate-180" : ""}`}
                    />
                    <span
                      aria-hidden
                  ...
                  <div
                    className={`absolute left-1/2 top-full w-[286px] -translate-x-1/2 pt-4
          ...
          <div className="flex items-center gap-3">
            <span className="hidden sm:block">
              <BotaoLink href="/apoie" tom="claro" className="px-5 py-3 text-[0.875rem]">
                Apoie
              </BotaoLink>
            </span>
                    ...
                    <li key={item.href}>
                      ...
                      >
                        ...
                        {ativo && (
                          <span
                            aria-hidden
                            className="ml-2.5 h-1 w-1 rounded-full bg-gold-300"
                          />
                        )}
                      </Link>
                    </li>
